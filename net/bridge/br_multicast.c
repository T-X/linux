				      ...
				      struct netlink_ext_ack *extack)
{
	...
	struct switchdev_attr attr = {
		...
		.u.mc_active = {
			...
			.ip4 = brmctx->ip4_active,
			.ip6 = brmctx->ip6_active,
			.ip4_changed = brmctx->ip4_active != ip4_active_old,
			.ip6_changed = brmctx->ip6_active != ip6_active_old,
		},
	};
				      ...
				      struct netlink_ext_ack *extack)
{
	...
	if (err) {
		...
		brmctx->ip4_active = ip4_active_old;
